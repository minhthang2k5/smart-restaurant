...
exports.createItem = async (req, res) => {
  try {
    ...
    // Ensure the category exists and get its restaurant
    ...
    // Create menu item (inherit restaurant from category)
...
exports.updateItem = async (req, res) => {
  try {
    ...
    // If category_id is being changed, validate new category and sync restaurant_id
    if (updateData.category_id) {
      ...
      updateData.restaurant_id = category.restaurantId;
    }

    // Find and update
    const [updatedCount, [updatedItem]] = await MenuItem.update(updateData, {
      where: {
        id,
        is_deleted: false,
      },
